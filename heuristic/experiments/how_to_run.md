...
The file manager that represents the link between **Model** and **Tail** is `./run_experiment.sh`.
Here we show an example of execution.

1. Run `./run_experiment.sh` script.

```
(base) amministratore@Gabris-MacBook-Air test % bash ./run_experiment.sh
1) continue...
2) run
3) exit
#? 
...
It ispossible to execute two instances in parallel. Example: write '-parallel' if you want 
to execute Instancesv2/ and Instancesv2_round/ concurrently.
...
Instancesv2_round/
Instancesv2/
Instancesv2_round/random/
Instancesv2_round/sipp/
Instancesv2_round/sippv2/
Do you want to export these variables?[y/n]y
digit -round or -random or -sipp or -sippv2 or -parallel or -parallel_sipp105 for selecting Instancesv2_round/ or Instancesv2_round/random/ or Instancesv2_round/sipp/ or Instancesv2_round/sippv2/ or (-round and -sippv2) or (-random and -sippv2 and sipp):
```
...
6. Once you type 3, the experiment begins!